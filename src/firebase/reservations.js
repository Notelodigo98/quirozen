...
export const saveReservation = async (reservation, serviciosList = []) => {
  try {
    ...
    try {
      ...
      console.warn('   La reserva se guardó correctamente, pero no se sincronizó con Google Calendar.');
      console.warn('   Para configurar Google Calendar, visita: /setup-calendar.html');
    }
