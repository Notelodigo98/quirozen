        ...
        <div className="footer-content">
          ...
          <div className="footer-section footer-social">
            ...
            <div className="footer-social-item">
              ...
              <a href="https://www.instagram.com/quirozendh1" target="_blank" rel="noopener noreferrer" className="footer-link">@quirozendh1</a>
            </div>
            <div className="footer-social-item">
              <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="footer-social-item">
              ...
              <a href="https://www.facebook.com/quirozendh1" target="_blank" rel="noopener noreferrer" className="footer-link">@quirozendh1</a>
            </div>
          </div>
